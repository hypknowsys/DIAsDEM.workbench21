...
REM
REM After setting the following two environment variables, DIAsDEMgui -- the
REM interactive graphic user interface of the DIAsDEM Workbench -- can be
...
REM directory will also contain the file DIAsDEMgui.config as well. This
REM environment variable must be adjusted according to the installation of
REM the DIAsDEM Workbench. Example: SET DIAsDEM_HOME=C:\DIAsDEM.workbench22
REM
